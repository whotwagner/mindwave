...
describe Mindwave do
  let(:mw) {Mindwave::Headset.new(nil,'/dev/ttyUSB0',false,115200)}
...
# D, [2016-09-07T20:53:01.403691 #20974] DEBUG -- : HEX: 8f DEC: 143
	...
	expect(mw.attention).to eq(37)
	expect(mw.meditation).to eq(10)
	expect(mw.poor).to eq (26)
	expect(mw.asic).to eq ([5, 189, 195, 2, 92, 40, 0, 160, 225, 0, 111, 202, 1, 8, 43, 0, 225, 158, 0, 119, 160, 0, 43, 199])
  end
end
